...
class SchedulerApp(tk.Tk):
    ...
    def showFrame(self, cont) -> None:
        ...
        elif cont == LotteryFrame or cont == RoundRobinFrame or cont == MLFQFrame:
...
class ProcessConfigFrame(tk.Frame):
    def __init__(self, parent, controller) -> None:
        ...
        io_dropdown = ttk.Combobox(self, textvariable=self.io_type_choice,
                                   values=["Probability", "Pattern"])
        io_dropdown.pack(pady=10, padx=10)
...
class MLFQConfigFrame(tk.Frame):
    ...
    def createLevelFrames(self) -> None:
        for level in range(self.num_levels):
            ...
            self.level_frames.append((level_frame, type_var, quanta_entry))
...
class CustomProcessCreationFrame(tk.Frame):
    def __init__(self, parent, controller) -> None:
        ...
        self.process_frames = []
        self.io_type = self.controller.frames[ProcessConfigFrame].io_type
    ...
    def createProcessFrames(self) -> None:
        for process_num in range(self.num_processes):
            ...
            self.process_frames.append((process_frame, arrival_entry, burst_entry, io_entry))
    ...
    def addIoConfiguration(self, process_frame, io_type) -> None:
        if io_type == "Probability":
            ...
            prob_io_label.pack(side="bottom", padx=5)
            prob_io_entry = tk.Entry(process_frame)
            prob_io_entry.pack(side="bottom", padx=5)
    ...
    def proceed(self, controller) -> None:
        self.controller.showFrame(FinalFrame)
        pass
...
class FinalFrame(tk.Frame):
    def __init__(self, parent, controller) -> None:
        ...
        # TODO: Display the metrics for each process here
    ...
    def displayGanttChart(self) -> None:
        # TODO: Implement the functionality to display the Gantt chart
        pass
